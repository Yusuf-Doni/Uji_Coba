...
import JabatanAdd from '@/views/master/jabatan/JabatanAdd.vue';
...
describe('JabatanAdd.vue', () => {
    ...
    it('should handle success save', async () => {
        const wrapper = factory();
        JabatanService.post.mockResolvedValue({
    ...
    it('should handle success edit', async () => {
        const wrapper = factory();
        JabatanService.put.mockResolvedValue({
            data: { code: 200, message: 'Success' }
        });

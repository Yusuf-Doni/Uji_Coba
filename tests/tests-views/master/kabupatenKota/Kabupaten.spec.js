...
import KabupatenAddDialog from '@/views/master/kabupatenKota/KabupatenAddDialog.vue';
import Kota from '@/views/master/kabupatenKota/Kota.vue';
...
describe('Kota.vue', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        KotaService.get.mockResolvedValue(mockDataList);
    });
    ...
    describe('Feature Component', () => {
        it('should open add dialog', async () => {
            ...
            expect(wrapper.vm.dataKota).toEqual({});
            expect(wrapper.findComponent(KabupatenAddDialog).exists()).toBe(
                true
            );
        });
        ...
        it('should handle success delete', async () => {
            const wrapper = factory();
            KotaService.delete.mockResolvedValue({

...
import StatusUserAdd from '@/views/master/statusUser/StatusUserAdd.vue';
...
describe('StatusUserAdd.vue', () => {
    ...
    it('should handle success save', async () => {
        const wrapper = factory();
        StatusUserService.post.mockResolvedValue({

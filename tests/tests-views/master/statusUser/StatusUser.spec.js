...
import StatusUser from '@/views/master/statusUser/StatusUser.vue';
...
vi.mock('@/service/StatusUserService', () => ({
    default: {
        get: vi.fn(),
        delete: vi.fn()
    }
...
describe('StatusUser.vue', () => {
    ...
    describe('Initial State', () => {
        it('renders DataTable on mount', () => {
            StatusUserService.get.mockResolvedValue({
                data: {
                    code: 200,
                    success: true,
                    size: 20,
    ...
    describe('Feature Component', () => {
        ...
        it('should handle success delete', async () => {
            const wrapper = factory();
            StatusUserService.delete.mockResolvedValue({

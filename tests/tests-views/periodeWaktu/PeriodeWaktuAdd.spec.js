...
import PeriodeWaktuAdd from '@/views/periodeWaktu/PeriodeWaktuAdd.vue';
...
describe('PeriodeWaktuAdd.vue', () => {
    ...
    it('should handle success save', async () => {
        const wrapper = factory();
        PeriodeWaktuService.post.mockResolvedValue({
    ...
    it('should handle success edit', async () => {
        const wrapper = factory();
        PeriodeWaktuService.put.mockResolvedValue({
            data: { code: 200, message: 'Success' }
        });

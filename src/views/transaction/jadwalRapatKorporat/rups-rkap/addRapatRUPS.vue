...
const scheduleForm = ref({
    ...
    durasi: null,
    deskripsi: '',
    kodeJenisRapat: '3' // RUPS dan RKAP
});
        ...
        accept: async () => {
            try {
                ...
                if (response.data && response.data.success) {
                    ...
                    setTimeout(() => {
                        router.push(`/transaction/rapat-rups-rkap/${scheduleForm.value.tahun || new Date().getFullYear()}/3`);
                    }, 1000);
                } else {
...
onMounted(() => {
    ...
    jenisRapatParam.value = route.query.jenisRapat || '3';
    ...
    scheduleForm.value.kodeJenisRapat = jenisRapatParam.value || '3';
            ...
            <template #content>
                <div class="space-y-6">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-sm text-gray-600">Lengkapi informasi jadwal rapat RUPS RKAP</p>
                    </div>

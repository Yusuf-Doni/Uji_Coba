...
const previewFile = async (file) => {
    try {
        ...
        const uploadFileType = file.uploadFileType || 'DOKUMEN_RUPS_RKAP';
...
const goBack = () => {
    ...
    const jenisRapat = route.query.jenisRapatParam || '3';
    router.push(`/transaction/rapat-rups-rkap/${tahun}/${jenisRapat}`);
};
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h2 class="text-xl font-bold text-gray-800 mb-2">
                                {{ rapatData.jadwalAgenda || 'Rapat RUPS RKAP' }}
                            </h2>
                ...
                <template #content>
                    <TabView v-model:activeIndex="activeTab">
                        ...
                        <div class="text-left mb-6">
                            ...
                            <p class="text-sm text-gray-600">Detail informasi jadwal rapat RUPS RKAP</p>
                        </div>
                    ...
                    <TabPanel>
                        ...
                        <div class="text-left mb-6">
                            ...
                            <p class="text-sm text-gray-600">Dokumen yang terlampir untuk rapat RUPS RKAP</p>
                        </div>

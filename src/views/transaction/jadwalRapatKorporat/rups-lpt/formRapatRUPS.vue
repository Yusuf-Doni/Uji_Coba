...
const previewFileName = ref('Dokumen RUPS LPT');
...
const finishAndRedirect = () => {
    ...
    router.push(`/transaction/rapat-rups-lpt/${tahun}/4`);
};
...
const checkExistingFile = async () => {
    ...
    try {
        const response = await RapatRUPSService.viewFile(jadwalRapatId.value, 'DOKUMEN_RUPS_LPT');
...
onMounted(async () => {
    ...
    if (!meetingId) {
        ...
        router.push('/transaction/rapat-rups-lpt');
        return;
    }
...
<template>
    <div>
        ...
        <div class="font-semibold text-xl mb-4">
            Edit Rapat RUPS LPT - Upload & Arahan
        </div>
            ...
            <template #content>
                <TabView v-model:activeIndex="activeTab">
                    ...
                    <div class="text-left mb-6">
                        ...
                        <p class="text-sm text-gray-600">Upload dokumen yang diperlukan untuk rapat RUPS LPT</p>
                    </div>
                            ...
                            <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                                ...
                                <div v-if="fileAlreadyUploaded" class="flex gap-2">
                                    ...
                                    <Button
                                        ...
                                        icon="pi pi-eye"
                                        severity="info"
                                        @click="previewFile('DOKUMEN_RUPS_LPT')"
                                    />
                                </div>
